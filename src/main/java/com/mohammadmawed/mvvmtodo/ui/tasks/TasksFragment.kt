...
import com.mohammadmawed.mvvmtodo.databinding.FragmentTasksBinding
import com.mohammadmawed.mvvmtodo.util.exhaustive
import com.mohammadmawed.mvvmtodo.util.onQueryTextChanged
            ...
            viewModel.tasksEvent.collect { event ->
                when (event) {
                    is TasksViewModel.TasksEvent.ShowUndoDeleteTaskMessage -> {
                        Snackbar.make(requireView(), R.string.delete_task, Snackbar.LENGTH_LONG)
